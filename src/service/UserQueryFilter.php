...
class UserQueryFilter extends AbstractDoctrineQueryFilter
{
    ...
    {
        $this->qb->join($this->getBaseClassAlias().'.admin',Administrador::ALIAS);
        $this->qb->join($this->getBaseClassAlias().'.tipo',Tipo::ALIAS);
        return parent::getJoins(); // TODO: Change the autogenerated stub
    }
